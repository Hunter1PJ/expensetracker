...
fun BudgetsPlaceholderScreen(
    ...
    Column(
        modifier = modifier
            ...
            .testTag("budgets_placeholder_screen"),
        horizontalAlignment = Alignment.CenterHorizontally
    ) {
        SectionHeader(
            title = stringResource(R.string.placeholder_budgets_title),
            subtitle = "Spending limits & targets"
        )
        ...
        ExpenseTrackerCard(
            ...
            EmptyState(
                title = stringResource(R.string.placeholder_budgets_title),
                description = stringResource(R.string.placeholder_budgets_desc),
